 ...
 */
public class WifiConnectIntent extends Intent implements TECIntent {

    public WifiConnectIntent(Context context, WifiConnection connection) {
        super(context, WifiConnectionService.class);
        Preconditions.checkNotNull(connection);

        setAction(ACTION_WIFI_CONNECT);
